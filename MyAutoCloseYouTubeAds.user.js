...
const CSS = {
    ...
    homeAdContainer: 'yt-mealbar-promo-renderer,#masthead-ad,#big-yoodle,.ytd-ad-slot-renderer,ytd-ad-slot-renderer.style-scope.ytd-rich-item-renderer,ytd-in-feed-ad-layout-renderer.style-scope.ytd-ad-slot-renderer,div.style-scope.yt-mealbar-promo-renderer'
}
